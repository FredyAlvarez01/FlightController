package com.alvarez.edu.flightmodeapp.postura;
...
public class AttitudeIndicator extends View {
    ...
    private void initialize() {
        ...
        yawPaint.setColor(Color.parseColor("#FF676262"));
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        skyPaint.setShader(new LinearGradient(0, -radiusInternal, 0, radiusInternal, Color
                .parseColor("#000000"), Color.parseColor("#2cb1e1"), Shader.TileMode.CLAMP));

        groundPaint.setShader(new LinearGradient(0, radiusInternal, 0, radiusInternal, Color
                .parseColor("#39BB51"), Color.parseColor("#39BB51"), Shader.TileMode.CLAMP));
